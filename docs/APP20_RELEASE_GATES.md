...
**2026-09-06 preparation update:** mainnet preparation has been reopened by the user. See [MAINNET_RUNBOOK.md](MAINNET_RUNBOOK.md) for the current candidate, read-only verification and remaining execution requirements. The historical full-RFQ release evidence below does not establish readiness for the new Chat candidate.
